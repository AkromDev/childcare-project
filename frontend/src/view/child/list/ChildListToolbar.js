...
class ChildToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=child">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: childSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: childSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ChildToolbar);
