...
import selectors from 'modules/child/childSelectors';

class ChildViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(ChildViewItem);
